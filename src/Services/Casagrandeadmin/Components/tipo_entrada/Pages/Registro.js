...
class Registro extends React.Component {
  ...
  getregistro() {
    let data = {};
    if (this.key) {
      data = tipo_entrada.Actions.getByKey(this.key, this.props);
      ...
      <SForm
        ...
        inputs={{
          ...
          color: {
            ...
            type: 'text',
            isRequired: true,
            defaultValue: data['color'] ?? "#E2E335"
          },
          precio: {
            label: 'Precio',
            type: 'money',
        ...
        onSubmit={(values) => {
          if (this.key) {
            tipo_entrada.Actions.editar({ ...data, ...values }, this.props);
          } else {
            tipo_entrada.Actions.registro(
  ...
  render() {
    var reducer = this.props.state[tipo_entrada.component + 'Reducer'];
