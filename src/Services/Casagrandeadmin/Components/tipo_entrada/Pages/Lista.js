...
class Lista extends React.Component {
  ...
  getTipo_entradaTabla() {
    var data = tipo_entrada.Actions.getByKeyEvento(this.key, this.props);
          ...
          },
          {
            ...
            component: (item) => {
              return (
                <SView
                  onPress={() => {
                    SNavigation.navigate('admin/tipo_entrada/registro', {
                      key: item
                    });
                  }}>
                ...
                <SView
                  ...
                  onPress={() => {
                    ...
                    SPopup.confirm({
                      ...
                      onPress: () => {
                        tipo_entrada.Actions.eliminar(obj, this.props);
                      }
                    });
                  }}>
                  <SIcon name={'Delete'} />
