    ...
    return (
      <STable2
        ...
        header={[
          ...
          { key: 'descripcion', label: 'Descripción', width: 150 },
                ...
                <SView
                  ...
                  onPress={() => {
                    SPopup.confirm({
                      ...
                      onPress: () => {
                        evento.Actions.eliminar(data[key], this.props);
                      }
                    });
                  }}>
                  <SIcon name={'Delete'} />
          ...
          },
          {
            ...
            component: (item) => {
              return (
                <SView
                  onPress={() => {
                    SNavigation.navigate('admin/evento/perfil', { key: item });
                  }}>
          ...
          },
          {
            ...
            component: (key) => {
              return (
                <SView
                  onPress={() => {
                    SNavigation.navigate('ventas', { key_evento: key });
                  }}>
