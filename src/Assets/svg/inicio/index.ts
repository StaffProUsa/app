...
import BackHead, { ReactComponent as BackHeadW } from './backHead.svg';
import User, { ReactComponent as UserW } from './user.svg';
...
const Assets = {
	...
	"BackHead": { Native: BackHead, Web: BackHeadW },
	"User": { Native: User, Web: UserW },
