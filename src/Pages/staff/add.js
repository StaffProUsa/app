...
export default class add extends Component {
    ...
    componentDidMount() {
        ...
        SSocket.sendPromise({
            ...
            this._ref["location"].setValue(e.data.location)
    ...
    handlePress() {
        ...
        // console.log("fecha_inicio", fecha_inicio.toString("yyyy-MM-dd hh:mmTZD"));
    ...
    render() {
        ...
        let location = "Ubicación del staff";
        ...
        >
            <Container>
                <SView row col={"xs-12"} style={{
                    ...
                    <SInput ref={r => this._ref["location"] = r} label={location} placeholder={location} type='text'
