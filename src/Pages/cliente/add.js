            ...
            <Container loading={(this.pk && !this.state.data)}>
                <SForm
                    ...
                    inputs={{
                        ...
                        "telefono": { col: "xs-12 sm-4.5", label: SLanguage.select({es:"Número de teléfono", en:"Phone Number"}), type:"phone", required: false, defaultValue: this.state?.data?.telefono },
