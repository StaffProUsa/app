            ...
            <Container loading={(this.pk && !this.state.data)}>
                <SForm
                    ...
                    inputs={{
                        ...
                        "contacto": { col: "xs-12 sm-7", label: SLanguage.select({es:"Nombre de contacto", en:"Contact name"}), required: true, defaultValue: this.state?.data?.contacto },
                        "telefono": { col: "xs-12 sm-4.5", label: SLanguage.select({es:"Número de teléfono", en:"Phone Number"}), type:"phone", required: true, defaultValue: this.state?.data?.telefono },
