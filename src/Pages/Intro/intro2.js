    ...
    render() {
        ...
        return (
            <SPage title={''} hidden footer={<SView col={'xs-12'} style={{ alignItems: 'flex-end', position: "absolute", bottom: 25, right: 25, }} >
                <SText fontSize={30} center bold color={STheme.color.primary}>Fast and effective</SText>
                <SText fontSize={30} center bold color={STheme.color.primary}>solutions</SText>
                <SHr height={25} />
                <SView col={'xs-12'} row>
                    ...
                    <SView col={'xs-6'} style={{alignItems: 'flex-end'}}>
                        <SView onPress={() => {
                            SNavigation.navigate('/intro/tres')
                        }}>
                ...
                <SImage src={require('../../Assets/images/intro2.jpg')} style={{ resizeMode: "cover", zIndex: 9, position: "absolute" }} />
            </SPage >
        );
    }
}
...
export default connect(initStates)(intro2);