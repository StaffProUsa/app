                    ...
                    <SView flex height style={{
                        ...
                        <SView row>
                            ...
                            <SText fontSize={13} language={{
                                en: "Start " + new SDate(obj.fecha_inicio, "yyyy-MM-ddThh:mm:ss").toString("HH"),
                                es: "Inicio " + new SDate(obj.fecha_inicio, "yyyy-MM-ddThh:mm:ss").toString("HH")
                            }} />

                            {(obj.fecha_fin != null) ?<SText fontSize={13} language={{
                                en: " | End " + new SDate(obj.fecha_fin, "yyyy-MM-ddThh:mm:ss").toString("HH"),
                                es: " | Fin " + new SDate(obj.fecha_fin, "yyyy-MM-ddThh:mm:ss").toString("HH")
                            }} /> : null}
