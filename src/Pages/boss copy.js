        ...
        >
            <SView col={"xs-12"} height backgroundColor={STheme.color.background} withoutFeedback>
                ...
                >
                    ...
                    />
                    <DinamicTable.Col key={"nombre"} label={SLanguage.select({ en: "Name", es: "Nombre" })} width={100}
                        data={e => { return users[e.row.key_usuario]?.Nombres + " " + users[e.row.key_usuario]?.Apellidos }}
                    />
                    <DinamicTable.Col key={"employee_number"} label={SLanguage.select({ en: "Employee Number", es: "Número de empleado" })} width={120}
