...
export default class CardEvento extends Component<{ data: ObjectStaffUsuario, onPress?: () => void }> {
    ...
    renderItemInvitation() {
        const { data } = this.props;
        if (!!data?.staff_usuario?.fecha_aprobacion_invitacion) return <SView height={18} style={{
